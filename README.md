...
- O objetivo é disponibilizar todos os códigos aqui, mas enquanto não da tempo para organizar os antigos (compartilhados via google colab), irei adicionando os novos e vida que segue.
  - Espero que possam ser úteis para alguém! Mas cuidado ao utilizá-los em projetos profissionais, a maioria deles tem objetivo de apresentar algum conceito em específico e muitas vezes não seguem padrões, ou se quer fazem algum sentido fora do contexto de estudo. 
    -  Inclusive, sinta-se livre para apontar melhorias nos códigos disponibilizados aqui. Em aulas seguiremos utilizando os modelos simplificados, mas as contribuições podem ser úteis em diferentes contextos. Seguem os contatos abaixo ou faz um fork.
